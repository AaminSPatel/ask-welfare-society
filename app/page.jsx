...
const FounderCarousel = ({ founders = [] }) => {
  ...
  const nextSlide = useCallback(() => {
    setIsAnimating(true);
    setTimeout(() => {
      setCurrentIndex((prevIndex) => (prevIndex + 1) % displayFounders.length);
      setIsAnimating(false);
    }, 800);
  }, [displayFounders.length]);
  ...
  const currentFounder = displayFounders[currentIndex];
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-white/60">
                        ...
                        <p className="text-xs">कुल सदस्य: {displayFounders.length}</p>
                      </div>
                    </div>
                  </motion.div>
                </motion.div>
        ...
        >
          <div className="inline-flex items-center space-x-4 bg-white/80 backdrop-blur-sm px-6 py-3 rounded-full shadow-lg">
            ...
            <span className="text-emerald-800 font-semibold">
              कुल {displayFounders.length} समर्पित सदस्य
            </span>
          </div>
        </motion.div>
      </div>
